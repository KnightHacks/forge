...
- Hackathon creation initializes editable General and MLH Challenges groups. Migration 0055 initializes existing hackathons that have never had group setup. `HackathonJudgingConfiguration.challengeGroupsInitializedAt` prevents individual group deletion/renaming from being undone by later imports; a full inventory drop preserves groups and this marker.
