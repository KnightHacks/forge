...
- The first import creates editable General and MLH Challenges groups. `HackathonJudgingConfiguration.challengeGroupsInitializedAt` prevents individual group deletion/renaming from being undone by later imports; a full inventory drop clears this marker.
