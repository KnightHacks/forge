...
- When replacing an existing workflow, inspect the current interaction flow and
...
- Use real product/domain assets where available. For Blade, prefer the Knight Hacks mark, established Blade assets, grid language, and purple system accents already used by the product.
