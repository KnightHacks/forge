...
/** One event-aware transactional template, used for initial claims and invitations. */
export function projectClaimEmail(input: {
  ...
  const event = escapeHtml(input.event);
