...
export const GemiKnightsConfirmationEmail = ({
  name,
  ...
  <Html>
    <Tailwind>
      <Head />
      <Preview>
        GemiKnights 2025 - FINAL STEP: Complete MLH Registration!
      </Preview>
          ...
          <Section className="px-10 py-8">
            ...
            <Section className="mt-8 text-center">
              ...
              <Link
                ...
                className="inline-block rounded-xl bg-red-600 px-6 py-3 text-lg font-bold text-white no-underline"
              >
...
export default GemiKnightsConfirmationEmail;
