...
/** General is the canonical import-created challenge; it has no rename API. */
export function isSponsorChallenge(label: string) {
  return label !== "General" && !isMlhChallenge(label);
}
