export const AUDITED_ADMIN_PROCEDURES = [
  ...
  "project-challenges.deleteGroup",
...
export const EXCLUDED_ADMIN_PROCEDURES = [
  ...
  "event.listAnnouncementChannels",
  "event.listAttendees",
  ...
  "hackathon-event.listAnnouncementChannels",
  ...
  "hacker.statusCounts",
  "issues.get",
  "issues.createImageUpload",
  "issues.getImageDownload",
  "issues.list",
