...
export const SPONSOR_WEBSITE_URLS: Record<string, string> = {
...
export const PAST_SPONSORS = [
  ...
  },
  {
    ...
    logoUrl: ONLINE_SPONSOR_LOGOS["texas instruments"],
  },
  {
    id: "twilio",
    name: "Twilio",
    logoUrl: ONLINE_SPONSOR_LOGOS.twilio,
  },
  {
    id: "amd",
    name: "AMD",
