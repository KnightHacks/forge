...
const Hero = ({ bladeUrl }: { bladeUrl: string }) => {
  return (
    <section className="relative min-h-screen overflow-hidden px-4 py-12">
      <SwordSVG className="animate-float absolute -left-10 top-8 hidden w-75 text-purple-400 opacity-50 md:block" />
      <NeonTkSVG className="animate-float absolute bottom-20 right-20 hidden w-75 text-purple-500 opacity-50 md:block" />
        ...
        <div className="grid min-h-[calc(100vh-6rem)] items-center gap-8 lg:grid-cols-2">
          <div className="order-2 text-center lg:order-1 lg:text-left">
            ...
            <div className="mt-8 flex justify-center md:justify-start">
              <div className="relative z-0 flex max-w-max items-center overflow-hidden rounded-lg p-0.75">
