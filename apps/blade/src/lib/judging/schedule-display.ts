...
export const appointmentStatusStyles = {
  ...
  incomplete: "border-amber-400/50 bg-amber-400/10 text-amber-200",
  missed: "border-red-400/50 bg-red-400/10 text-red-200",
  complete:
    "border-[hsl(var(--chart-2)/0.5)] bg-[hsl(var(--chart-2)/0.15)] text-[hsl(var(--chart-2))]",
} as const;
