...
const faqData: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Here's the link to the hackers guide. If a question wasn't answered feel free to ask in the ",
    links: [
...
export default function Faq() {
  return (
    <div className="relative z-10 mb-60 flex h-full w-full justify-center px-4 md:mb-70 lg:mb-95">
