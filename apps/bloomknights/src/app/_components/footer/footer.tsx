    ...
    <div className="font-dm-sans w-full font-semibold">
      <div className="flex w-full flex-col items-center justify-center">
        <div className="w-[90%] sm:w-[85%] md:w-4/5">
          <Separator className="mb-3 mt-6 h-[1px] bg-[rgba(180,140,80,0.4)] sm:mb-4 sm:mt-8 md:mt-10" />
        </div>
            ...
            <React.Fragment key={index}>
              <div className="mx-4 flex flex-row items-center justify-center sm:mx-6 md:mx-10">
                {link.href.startsWith("mailto:") ? (
                  <a
                    href={link.href}
                    className="wc-ink-soft transform text-center text-base transition duration-300 hover:scale-105 hover:text-[#7a4a1e] sm:text-lg"
                  >
                    {link.text}
                  </a>
                ) : (
        ...
        <div className="my-6 flex justify-center px-4 sm:my-8 sm:px-6 md:my-10 md:px-8">
          <span className="wc-ink-soft text-center text-sm sm:text-base">
            {footerMessage}
          </span>
        </div>
      </div>
