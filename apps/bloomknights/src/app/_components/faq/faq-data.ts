    ...
    items: [
      {
        ...
        answer:
          "BloomKnights is a 12-hour beginner-friendly student hackathon hosted by Knight Hacks at the University of Central Florida, where participants create innovative projects in a single day.",
      },
      {
        question: "When and where is it happening?",
        answer:
          "BloomKnights will take place in person on July 11, 2026 at BA1 on UCF Main Campus in Orlando, Florida. For the most recent information on check-in and schedule, please refer to the Hackers Guide.",
      },
      {
        question: "How is BloomKnights different from Knight Hacks?",
        answer:
    ...
    items: [
      {
        ...
        answer:
          "BloomKnights is open to current college students of all majors and experience levels. Beginners are welcome, and you do not need prior hackathon experience to participate.",
      },
      {
        question: "Is it free?",
        answer:
