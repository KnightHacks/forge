...
// Remember to update this to the production KH role ID
export const DISCORD_HACKATHON_ROLE_ID = process.env.NODE_ENV === "production" ? "1420819573816692857" : "1420819573816692857";
