...
export const env = createEnv({
  server: {
    ...
    DISCORD_ANIMAL_WEBHOOK_URL: z.string().optional(),
    DISCORD_LEETCODE_DAILY_WEBHOOK_URL: z.string().optional(),
    DISCORD_WEATHER_API_KEY: z.string().optional(),
    DISCORD_DAILY_REMINDERS_WEBHOOK_URL: z.string().optional(),
    DISCORD_PRE_DAILY_REMINDERS_WEBHOOK_URL: z.string().optional(),
    DISCORD_HACKATHON_WEBHOOK_URL: z.string().optional(),
    DATABASE_URL: z.string(),
    RESEND_API_KEY: z.string(),
    RESEND_FROM_EMAIL: z.string().email(),
    EMAIL_QUEUE_CRON: z.string().optional(),
    EMAIL_DAILY_LIMIT: z.string().optional(),
    DISCORD_EMAIL_QUEUE_CHANNEL_ID: z.string().optional(),
  },
  runtimeEnvStrict: {
