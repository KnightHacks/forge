...
| ------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [Desktop navigation screenshot](navigation-desktop.png) | The Members destination highlights and the top progress bar appears while the current Forms page remains usable.                   |
| [Desktop navigation video](navigation-desktop.mp4)      | Immediate feedback, completed navigation, browser back, and a repeated navigation without stuck loading.                           |
| [Mobile navigation screenshot](navigation-mobile.png)   | The 320px drawer closes immediately, with a static progress indicator in reduced-motion mode.                                      |
| [Mobile navigation video](navigation-mobile.mp4)        | Mobile menu selection, immediate dismissal, and the completed destination. The clip begins after the test's desktop sign-in setup. |
| [Desktop skeleton](skeleton-desktop.png)                | Blade's root fallback at 1440px, using the existing logo, tokens, and inset rows.                                                  |
| [Mobile skeleton](skeleton-mobile.png)                  | The same fallback at 320px without horizontal overflow.                                                                            |
