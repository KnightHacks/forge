...
| R-20 | Prefer linked current Member full names in Issue history and Admin logs; fall back to stored Discord labels and preserve system actors.                     | In progress | jesusthecreator017 (2026-09-01) | TC-016, TC-NEG-003             |
...
| R-22 | Prevent overlapping current/prior hackathon comparison labels while preserving the accessible text/table alternative.                                       | In progress | jesusthecreator017 (2026-09-01) | TC-021                         |
| R-23 | Fix reported Chrome/Zen member and shell overflow at 320 px, intermediate widths, and desktop without hiding content behind overflow rules.                 | In progress | jesusthecreator017 (2026-09-01) | TC-020                         |
| R-24 | Verify and polish existing Forms text/image/video instruction-card authoring, upload feedback, ordering, cleanup, and respondent rendering.                 | In progress | jesusthecreator017 (2026-09-01) | TC-018, TC-NEG-003             |
